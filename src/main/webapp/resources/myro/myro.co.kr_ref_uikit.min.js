                                ...
                                e &&
                                    ...
                                    (t =
                                        (function (t, e) {
                                            if (!Ui[t]) {
                                                var n;
                                                for (Ui[t] = {}, qi.lastIndex = 0;
                                                    (n = qi.exec(t));) Ui[t][n[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + n[1] + 'svg>';
                                            }
                                            return Ui[t][e];
                                        })(t, e) || t);
    ...
    var Gr = Y({}, Si, {
        ...
        scale: {
            ...
            translate: function (t) {
                return [{
                        opacity: 1 - t,
                        transform: Yr(1 - 0.2 * t)
                    },
                    {
                        opacity: t,
                        transform: Yr(0.8 + 0.2 * t)
                    },
                ];
            },
        },
                    ...
                    handler: function (t, n) {
                        ...
                        void 0 === h && (h = {}),
                            ...
                            ((a = {
                                ...
                                ge('https://vimeo.com/api/oembed.json?maxwidth=1920&url=' + encodeURI(r), {
                                    responseType: 'json',
                                    withCredentials: !1
                                }).then(
                                    function (t) {
