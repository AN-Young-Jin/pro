...
!(function (t, e) {
    ...
    var Ve = {
        ...
        Re = { 'animation-iteration-count': !0, 'column-count': !0, 'fill-opacity': !0, 'flex-grow': !0, 'flex-shrink': !0, 'font-weight': !0, 'line-height': !0, opacity: !0, order: !0, orphans: !0, 'stroke-dasharray': !0, 'stroke-dashoffset': !0, widows: !0, 'z-index': !0, zoom: !0 };
    function qe(t, e, r, o) {
        return (
            void 0 === o && (o = ''),
            W(t).map(function (n) {
    ...
    var Je = rt(function (t) {
            ...
            var n,
                i = Ze.length;
            for (; i--; ) if ((n = '-' + Ze[i] + '-' + t) in e) return n;
        }),
        Ze = ['webkit', 'moz', 'ms'];
    function Qe(t, s, a, u) {
        return (
                ...
                W(t).map(function (o) {
                    return new le(function (e, n) {
                        ...
                        te(
                            ...
                            Be(o, 'uk-transition'),
                            qe(o, Y({ transitionProperty: Object.keys(s).map(Je).join(','), transitionDuration: a + 'ms', transitionTimingFunction: u }, s));
                    });
                }),
            )
        );
                ...
                W(t).map(function (r) {
                    return new le(function (e, n) {
                        ...
                        te(
                            ...
                            Be(r, o, en + (u ? 'leave' : 'enter')),
                            g(o, en) && (a && Be(r, 'uk-transform-origin-' + a), u && Be(r, en + 'reverse'));
                    });
                }),
            )
        );
    ...
    var rn = new RegExp(en + '(enter|leave)'),
        ...
        sn = { width: ['left', 'right'], height: ['top', 'bottom'] };
    function an(t) {
        t = _(t) ? j(t).getBoundingClientRect() : { height: ln(t), width: dn(t), top: 0, left: 0 };
    ...
    function un(n, i) {
        ...
        for (t in sn) for (var s in sn[t]) r[sn[t][s]] += o[t];
        if (!i) return r;
        var a = qe(n, 'position');
    ...
    function cn(t) {
        ...
        return _(a) && ((n -= (r = un(a)).top + L(qe(a, 'borderTopWidth'))), (i -= r.left + L(qe(a, 'borderLeftWidth')))), { top: n - L(qe(t, 'marginTop')), left: i - L(qe(t, 'marginLeft')) };
    }
    function hn(t) {
        var e = [0, 0];
        t = j(t);
    ...
    function pn(n, t, e) {
        return (
            ...
            qe(n, 'boxSizing') === e
                ? sn[t].map(p).reduce(function (t, e) {
    ...
    function mn(t) {
        for (var e in sn) for (var n in sn[e]) if (sn[e][n] === t) return sn[e][1 - n];
        return t;
    }
    function gn(t, e, n) {
    ...
    function _n(e, n, i) {
        var t,
            r,
            o = {};
        if (((n = k(n) ? n.options : n).extends && (e = _n(e, n.extends, i)), n.mixins)) for (var s = 0, a = n.mixins.length; s < a; s++) e = _n(e, n.mixins[s], i);
        for (t in e) u(t);
    ...
    function Mn(t) {
        if ((On(t) && Ln(t, { func: 'playVideo', method: 'play' }), Bn(t)))
            try {
                t.play().catch(Q);
            } catch (t) {}
    }
    function Nn(t) {
        On(t) && Ln(t, { func: 'pauseVideo', method: 'pause' }), Bn(t) && t.pause();
    }
    function zn(t) {
        On(t) && Ln(t, { func: 'mute', method: 'setVolume', value: 0 }), Bn(t) && (t.muted = !0);
    }
    function Dn(t) {
        return Bn(t) || On(t);
    }
    ...
    (In.events = In.created = In.beforeConnect = In.connected = In.beforeDisconnect = In.disconnected = In.destroy = Tn),
        (In.args = function (t, e) {
            return !1 !== e && Tn(e || t);
        }),
    ...
    function Zn(t, e, h, l, d, n, i, r) {
        ...
        return (
            Qn(g, h, p, -1),
            Qn(g, l, m, 1),
            (d = ei(d, p.width, p.height)),
            (n = ei(n, m.width, m.height)),
            (d.x += n.x),
            (d.y += n.y),
            (g.left += d.x),
            (g.top += d.y),
    ...
    (ii.util = ni),
        ...
        (ci = 0),
        ((ui = ii).prototype._init = function (t) {
            ((t = t || {}).data = (function (t, e) {
                ...
                (this.$options = _n(this.constructor.options, t, this)),
                (this.$el = null),
                (this.$props = {}),
                (this._uid = ci++),
                this._initData(),
        ...
        (ui.prototype._initEvents = function () {
            ...
            t &&
                t.forEach(function (t) {
                    ...
                    else for (var e in t) gi(n, t[e], e);
                });
        }),
        ...
        (hi.connect = function (t) {
            if (t[li]) for (var e in t[li]) t[li][e]._callConnected();
    ...
    var wi = {
        ...
        bi = {
            ...
            data: { cls: !1, animation: [!1], duration: 200, origin: !1, transition: 'linear', clsEnter: 'uk-togglabe-enter', clsLeave: 'uk-togglabe-leave', initProps: { overflow: '', height: '', paddingTop: '', paddingBottom: '', marginTop: '', marginBottom: '' }, hideProps: { overflow: 'hidden', height: 0, paddingTop: 0, paddingBottom: 0, marginTop: 0, marginBottom: 0 } },
            computed: {
                                                    ...
                                                    : ((o = u),
                                                      function (t, e) {
                                                          ...
                                                          var n = o.animation,
                                                              ...
                                                              r = o._toggle;
                                                          return e
                                                              ? (r(t, !0), on.in(t, n[0], i, o.origin))
                                                              : on.out(t, n[1] || n[0], i, o.origin).then(function () {
                                                                    return r(t, !1);
                                                                });
                                                      })
                                                : u._toggle
    ...
    function xi(t) {
        ...
        return function (t, e) {
            ...
            return (
                ln(t, r),
                (e
                    ? tn.start(t, Y({}, a, { overflow: 'hidden', height: i }), Math.round(s * (1 - r / i)), c)
                    : tn.start(t, u, Math.round(s * (r / i)), c).then(function () {
                          return h(t, !1);
                      })
                ).then(function () {
                    return qe(t, a);
                            ...
                            return o.toggleElement(t, !Le(t, o.clsOpen), function (e, n) {
                                ...
                                if (!1 !== r && o.hasTransition)
                                    return (
                                        ...
                                        ki(i, !1),
                                        xi(o)(e._wrapper, n).then(function () {
                                            var t;
                                            ki(i, !n), delete e._wrapper, Te(i), n && (Vn((t = Ne(o.$props.toggle, e))) || qn(t, { offset: o.offset }));
                                        })
                                    );
                                ki(i, !n);
                            });
    ...
    var $i = {
            ...
            args: 'animation',
            props: { close: String },
            data: { animation: [!0], selClose: '.uk-alert-close', duration: 150, hideProps: Y({ opacity: 0 }, bi.data.hideProps) },
            events: [
                {
                    name: 'click',
                    delegate: function () {
        ...
        Si = {
            ...
            update: {
                read: function () {
                    return !!Dn(this.$el) && { visible: $t(this.$el) && 'hidden' !== qe(this.$el, 'visibility'), inView: this.inView && Vn(this.$el) };
                },
                write: function (t) {
                    var e = t.visible,
                        t = t.inView;
            ...
            update: {
                read: function () {
                    var t = this.$el,
                        ...
                        n = e.offsetHeight,
                        e = e.offsetWidth,
                        n = nt.cover({ width: this.width || t.naturalWidth || t.videoWidth || t.clientWidth, height: this.height || t.naturalHeight || t.videoHeight || t.clientHeight }, { width: e + (e % 2 ? 1 : 0), height: n + (n % 2 ? 1 : 0) });
            ...
            update: {
                read: function () {
                    ...
                    return {
                        rows: t,
                        columns: (function (t) {
                            for (var e = [], n = 0; n < t.length; n++) for (var i = Di(t[n], 'left', 'right'), r = 0; r < i.length; r++) e[r] = e[r] ? e[r].concat(i[r]) : i[r];
    ...
    var Oi = {
        ...
        update: [
            ...
            },
            {
                read: function (t) {
                    t = t.height;
                    return !Pi(this.$el) && { scrolled: !!this.parallax && Un(this.$el, t ? t - ln(this.$el) : 0) * Math.abs(this.parallax) };
                },
                write: function (t) {
                    var e = t.columns,
                        i = t.scrolled,
    ...
    var Hi = ht
        ...
        Li = {
            ...
            update: {
                read: function () {
                    return { rows: (this.row ? zi(this.elements) : [this.elements]).map(Fi) };
                },
                write: function (t) {
    ...
    function Fi(t) {
        ...
        return (
            e && r && (qe(t, 'minHeight', ''), (n = t.map(ji)), (i = Math.max.apply(Math, n))),
            {
    ...
    var Wi = {
            ...
            update: {
                read: function (t) {
                    ...
                    return (
                        this.expand
                            ? (n = ln(window) - (an(document.documentElement).height - an(this.$el).height) - i || '')
                            : ((n = 'calc(100vh'),
                              this.offsetTop && (n += 0 < (t = un(this.$el).top) && t < ln(window) / 2 ? ' - ' + t + 'px' : ''),
                              !0 === this.offsetBottom ? (n += ' - ' + an(this.$el.nextElementSibling).height + 'px') : D(this.offsetBottom) ? (n += ' - ' + this.offsetBottom + 'vh') : this.offsetBottom && u(this.offsetBottom, 'px') ? (n += ' - ' + L(this.offsetBottom) + 'px') : N(this.offsetBottom) && (n += ' - ' + an(Lt(this.offsetBottom, this.$el)).height + 'px'),
                              (n += (i ? ' - ' + i + 'px' : '') + ')')),
                        { minHeight: n, prev: e }
                    );
                },
    ...
    var or = {
        ...
        connected: function () {
            window.IntersectionObserver
                ? (pr[this.cacheKey]
                      ? sr(this.$el, pr[this.cacheKey], this.dataSrcset, this.sizes)
                      : this.isImg &&
                        this.width &&
                        this.height &&
                        sr(
                            this.$el,
                            (function (t, e, n) {
                                n && ((n = nt.ratio({ width: t, height: e }, 'width', gn(ur(n)))), (t = n.width), (e = n.height));
                ...
                : sr(this.$el, this.dataSrc, this.dataSrcset, this.sizes);
        },
        disconnected: function () {
                ...
                this.dataSrcset &&
                    ...
                    ((!(n = qe(this.$el, 'backgroundSize')).match(/^(auto\s?)+$/) && L(n) !== t.bgSize) ||
                        ((t.bgSize =
                            ...
                            (n = this.sizes),
                            (i = gn(ur(n))),
                            (e = (e.match(lr) || []).map(L).sort(function (t, e) {
                                return t - e;
                            })).filter(function (t) {
                                return i <= t;
                            })[0] ||
            ...
            events: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        dn(window) > t.clientWidth && this.overlay && qe(document.body, 'overflowY', 'scroll'),
                            this.stack && qe(this.$el, 'zIndex', L(qe(this.$el, 'zIndex')) + wr.length),
                            Be(t, this.clsPage),
                            this.bgClose &&
                                te(
                                    this.$el,
                ...
                },
                {
                    ...
                    handler: function () {
                        var e = this;
                        w(wr, this) && wr.splice(wr.indexOf(this), 1),
                            wr.length || qe(document.body, 'overflowY', ''),
                            qe(this.$el, 'zIndex', ''),
                            wr.some(function (t) {
    ...
    (o = '.uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle'),
        (l = {
            ...
            data: { dropdown: o, align: lt ? 'right' : 'left', clsDrop: 'uk-navbar-dropdown', mode: void 0, offset: void 0, delayShow: void 0, delayHide: void 0, boundaryAlign: void 0, flip: 'x', boundary: !0, dropbar: !1, dropbarMode: 'slide', dropbarAnchor: !1, duration: 200, forceHeight: !0, selMinHeight: o, container: !1 },
            computed: {
                boundary: function (t, e) {
                    var n = t.boundary,
                        t = t.boundaryAlign;
                ...
                },
                {
                    ...
                    handler: function (t) {
                        ...
                        w(this.dropdowns, i) &&
                            ...
                            r === Sr.UP && (t.preventDefault(), 0 < i && n[i - 1].focus()),
                            r === Sr.DOWN && (t.preventDefault(), i < n.length - 1 && n[i + 1].focus()),
                            r === Sr.ESC && e && e.target && e.target.focus(),
                            kr(t, this.toggles, e));
                    },
                },
                {
            ...
            methods: {
                ...
                transitionTo: function (t, e) {
                    ...
                    return (
                        ...
                        tn.cancel([e, i]),
                        le
                            .all([tn.start(i, { height: t }, this.duration), tn.start(e, { clip: 'rect(0,' + e.offsetWidth + 'px,' + t + 'px,0)' }, this.duration)])
                            .catch(Q)
                            .then(function () {
    ...
    var Sr = { TAB: 9, ESC: 27, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40 },
        t = {
            mixins: [br],
            args: 'mode',
                ...
                },
                {
                    ...
                    handler: function () {
                        'reveal' !== this.mode || Le(Ct(this.panel), this.clsMode) || (Ie(this.panel, '<div>'), Be(Ct(this.panel), this.clsMode)),
                            ...
                            this.clsContainerAnimation && (Ir().content += ',user-scalable=0');
                    },
                },
                {
                    name: 'hide',
    ...
    var dt = {
            ...
            update: {
                read: function () {
                    return !!(this.content && this.container && $t(this.$el)) && { current: L(qe(this.$el, 'maxHeight')), max: Math.max(this.minHeight, ln(this.container) - (an(this.content).height - ln(this.$el))) };
                },
                write: function (t) {
                    var e = t.current,
                        t = t.max;
                ...
                scrollTo: function (t) {
                    ...
                    (t = (t && Ne(t)) || document.body),
                        ee(this.$el, 'beforescroll', [this, t]) &&
                            qn(t, { offset: this.offset }).then(function () {
            ...
            update: [
                {
                    read: function (t) {
                        ...
                        this.elements.forEach(function (t) {
                            t[Er] || (t[Er] = { cls: ut(t, 'uk-scrollspy-class') || e.cls }), (t[Er].show = Vn(t, e.offsetTop, e.offsetLeft));
                        });
                    },
                    write: function (n) {
                        var i = this;
            ...
            update: [
                {
                    read: function (t, e) {
                        ...
                        e = Tr('bottom', this);
                        return (this.top = Math.max(L(Tr('top', this)), this.topOffset) - this.offset), (this.bottom = e && e - this.$el.offsetHeight), (this.width = an($t(this.widthElement) ? this.widthElement : this.$el).width), { height: t, top: hn(this.placeholder)[0], margins: qe(this.$el, ['marginTop', 'marginBottom', 'marginLeft', 'marginRight']) };
                    },
                    write: function (t) {
                        var e = t.height,
                            n = t.margins,
                                    ...
                                    ? this.isFixed
                                        ? ((this.isFixed = !1),
                                          this.animation && c > this.topOffset
                                              ? (on.cancel(this.$el),
                                                on.out(this.$el, this.animation).then(function () {
                                                    return n.hide();
                                                }, Q))
                                              : this.hide())
                                        : on.inProgress(this.$el) && c < e && (on.cancel(this.$el), this.hide())
                                    : this.isFixed
                                    ? this.update()
                                    : this.animation
                                    ? (on.cancel(this.$el), this.show(), on.in(this.$el, this.animation).catch(Q))
                                    : this.show()));
                    },
                    events: ['resize', 'scroll'],
                },
            ...
            methods: {
                ...
                update: function () {
                    var t = 0 !== this.top || this.scroll > this.top,
                        ...
                        n = 'fixed';
                    D(this.bottom) && this.scroll > this.bottom - this.offset && ((e = this.bottom - this.offsetParentTop), (n = 'absolute')), qe(this.$el, { position: n, top: e + 'px', width: this.width }), (this.isActive = t), Fe(this.$el, this.clsBelow, this.scroll > this.bottomOffset), Be(this.$el, this.clsFixed);
                },
            },
        };
    function Tr(t, e) {
    ...
    X(
        Object.freeze({
            ...
            Margin: Ni,
            Modal: yr,
            Nav: { extends: yi, data: { targets: '> .uk-parent', toggle: '> a', content: '> ul' } },
            Navbar: l,
            Offcanvas: t,
            OverflowAuto: dt,
            Responsive: {
                ...
                update: {
                    read: function () {
                        return !!($t(this.$el) && this.width && this.height) && { width: dn(Ct(this.$el)), height: this.height };
                    },
                    write: function (t) {
        ...
        ct &&
            ...
            wn.read(function () {
                document.body && Me(document.body, _r),
                ...
                return (
                    ...
                    new le(function (r) {
                        return requestAnimationFrame(function () {
                            ...
                            o !== e && i.push(tn.start(s, { height: e }, a / 2 + n.length * u, 'ease')),
                                le.all(i).then(function () {
                                    Oe(s, Dr), c === Or(s) && (qe(s, { height: '', alignContent: '' }), qe(t, { opacity: '' }), delete s.dataset.transition), r();
                                });
                        });
                    })
                );
                        ...
                        var n,
                            ...
                            e =
                                ...
                                (t = (i = u).map(function (t, e) {
                                    return !!(Ct(t) && e in r) && (r[e] ? ($t(t) ? Wr(t) : { opacity: 0 }) : { opacity: $t(t) ? 1 : 0 });
                                })),
    ...
    function Fr(t, e) {
        var n = qe(t, 'zIndex');
        return !!$t(t) && Y({ display: '', opacity: e ? qe(t, 'opacity') : '0', pointerEvents: 'none', position: 'absolute', zIndex: 'auto' === n ? Ht(t) : n }, Wr(t));
    }
    function jr(t) {
    ...
    function Rr(t, e, n) {
        var i = Vr(t, e),
            ...
            e = i.sort,
            i = i.order;
        return void 0 === i && (i = 'asc'), (r || O(e)) && (t ? (r ? (delete n.filter[''], (n.filter[t] = r)) : (delete n.filter[t], (B(n.filter) || '' in n.filter) && (n.filter = { '': r || '' }))) : (n.filter = { '': r || '' })), O(e) || (n.sort = [e, i]), n;
    }
    Si = {
        slide: {
            show: function (t) {
                return [{ transform: Ur(-100 * t) }, { transform: Ur() }];
            },
            percent: qr,
            translate: function (t, e) {
                return [{ transform: Ur(-100 * e * t) }, { transform: Ur(100 * e * (1 - t)) }];
            },
        },
    };
    function qr(t) {
    ...
    nr = {
                        ...
                        Qt(document, gt, this.move, { passive: !1 }),
                            ...
                            this.dragging &&
                                ...
                                this.index === this.prevIndex
                                    ...
                                    : ((t = (lt ? this.dir * (lt ? 1 : -1) : this.dir) < 0 == this.prevPos > this.pos), (this.index = t ? this.index : this.prevIndex), t && (this.percent = 1 - this.percent), this.show((0 < this.dir && !t) || (this.dir < 0 && t) ? 'next' : 'previous', !0))),
        ...
        methods: {
            ...
            _show: function (t, e, n) {
                if (((this._transitioner = this._getTransitioner(t, e, this.dir, Y({ easing: n ? (e.offsetWidth < 600 ? 'cubic-bezier(0.25, 0.46, 0.45, 0.94)' : 'cubic-bezier(0.165, 0.84, 0.44, 1)') : this.easing }, this.transitionOptions))), !n && !t)) return this._translate(1), le.resolve();
                t = this.stack.length;
                    ...
                    return {
                        ...
                        show: function (t, e, n) {
                            ...
                            return (
                                ...
                                this.translate(e),
                                Xr(o, 'itemin', { percent: e, duration: t, timing: n, dir: s }),
                                Xr(r, 'itemout', { percent: 1 - e, duration: t, timing: n, dir: s }),
                        ...
                        translate: function (t) {
                            this.reset();
                            var e = i(t, s);
                            qe(o, e[1]), qe(r, e[0]), Xr(o, 'itemtranslatein', { percent: t, dir: s }), Xr(r, 'itemtranslateout', { percent: 1 - t, dir: s });
                        },
                        percent: function () {
                            return n(r || o, o, s);
                        },
                                ...
                                'image' === e || r.match(/\.(avif|jpe?g|a?png|gif|svg|webp)($|\?)/i)
                                    ? ve(r, h.srcset, h.size).then(
                                          function (t) {
                                              var e = t.width,
                                                  t = t.height;
                                              return i.setItem(n, Zr('img', Y({ src: r, width: e, height: t, alt: o }, h)));
                                          },
                                          function () {
                                              return i.setError(n);
                                          },
                                    ...
                                    ? (Zt((u = Zr('video', Y({ src: r, poster: c, controls: '', playsinline: '', 'uk-video': '' + this.videoAutoplay }, h))), 'loadedmetadata', function () {
                                    ...
                                    ? this.setItem(n, Zr('iframe', Y({ src: r, frameborder: '0', allowfullscreen: '', class: 'uk-lightbox-iframe' }, h)))
                                    : (s = r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/))
                                    ? this.setItem(n, Zr('iframe', Y({ src: 'https://www.youtube' + (s[1] || '') + '.com/embed/' + s[2] + (s[3] ? '?' + s[3] : ''), width: 1920, height: 1080 }, a, h)))
                                      ...
                                      ge('https://vimeo.com/api/oembed.json?maxwidth=1920&url=' + encodeURI(r), { responseType: 'json', withCredentials: !1 }).then(
                                          function (t) {
                                              var e = t.response,
                                                  t = e.height,
                                                  e = e.width;
                                              return i.setItem(n, Zr('iframe', Y({ src: 'https://player.vimeo.com/video/' + s[1] + (s[2] ? '?' + s[2] : ''), width: e, height: t }, a, h)));
                                          },
                                          function () {
                                              return i.setError(n);
                                          },
    ...
    Qi = {
        ...
        connected: function () {
            ...
            tn.start(qe(this.$el, this.startProps), (((t = { opacity: 1 })[this.marginProp] = n), t)).then(function () {
        ...
        update: {
            read: function (t, e) {
                ...
                if ((e.has('scroll') || (n = !1), this.matchMedia)) {
                    var i = n;
                    return (t = Un(this.target) / (this.viewport || 1)), (e = this.easing), { percent: (n = Z(t * (1 - (e - e * t)))), style: i !== n && this.getCss(n) };
                }
            },
            write: function (t) {
                t = t.style;
            ...
            Transitioner: function (u, c, h, t) {
                ...
                return {
                    ...
                    show: function (t, e, n) {
                        void 0 === e && (e = 0);
                        n = n ? 'linear' : r;
                        return (t -= Math.round(t * Z(e, -1, 1))), this.translate(e), (e = u ? e : Z(e, 0, 1)), ao(this.getItemIn(), 'itemin', { percent: e, duration: t, timing: n, dir: h }), u && ao(this.getItemIn(!0), 'itemout', { percent: 1 - e, duration: t, timing: n, dir: h }), tn.start(l, { transform: Ur(-d * (lt ? -1 : 1), 'px') }, t, n).then(o.resolve, Q), o.promise;
                    },
                    cancel: function () {
                        tn.cancel(l);
                    },
                        ...
                        (r = u ? Z(r, -1, 1) : 0),
                            Pt(l).forEach(function (t) {
                                var e = w(o, t),
                                    n = t === s,
                                    i = t === a;
                                ao(t, 'itemtranslate' + (n || (!i && (e || (h * (lt ? -1 : 1) == -1) ^ (oo(t, l) > oo(u || c)))) ? 'in' : 'out'), { dir: h, percent: i ? 1 - r : n ? r : e ? 1 : 0 });
                            });
                    },
                    percent: function () {
    ...
    var ho,
        Si = Y({}, Si, {
            ...
            scale: {
                show: function () {
                    return [{ opacity: 0, transform: Yr(1.5), zIndex: 0 }, { zIndex: -1 }];
                },
                percent: function (t) {
                    return 1 - qe(t, 'opacity');
                },
                translate: function (t) {
                    return [{ opacity: 1 - t, transform: Yr(1 + 0.5 * t), zIndex: 0 }, { zIndex: -1 }];
                },
            },
            pull: {
                show: function (t) {
                    return t < 0
                        ? [
                              { transform: Ur(30), zIndex: -1 },
                              { transform: Ur(), zIndex: 0 },
                          ]
                        : [
                              { transform: Ur(-100), zIndex: 0 },
                              { transform: Ur(), zIndex: -1 },
                          ];
                },
                ...
                translate: function (t, e) {
                    return e < 0
                        ? [
                              { transform: Ur(30 * t), zIndex: -1 },
                              { transform: Ur(-100 * (1 - t)), zIndex: 0 },
                          ]
                        : [
                              { transform: Ur(100 * -t), zIndex: 0 },
                              { transform: Ur(30 * (1 - t)), zIndex: -1 },
                          ];
                },
            },
            push: {
        ...
        Si = {
            ...
            data: { ratio: '16:9', minHeight: !1, maxHeight: !1, selList: '.uk-slideshow-items', attrItem: 'uk-slideshow-item', selNav: '.uk-slideshow-nav', Animations: Si },
            update: {
                read: function () {
                    var t = this.ratio.split(':').map(Number),
                        e = t[0],
                        t = ((t = t[1]) * this.list.offsetWidth) / e || 0;
                    return this.minHeight && (t = Math.max(this.minHeight, t)), { height: (t = this.maxHeight ? Math.min(this.maxHeight, t) : t) - pn(this.list, 'height', 'content-box') };
                },
                write: function (t) {
                    t = t.height;
        ...
        Hi = {
            ...
            methods: {
                init: function (t) {
                    ...
                    !r || i || 0 < n || It(e) || Bt(e, '.' + this.clsNoDrag) || (this.handle && !Bt(e, this.handle)) || (t.preventDefault(), (this.touched = new Set([this])), (this.placeholder = r), (this.origin = Y({ target: e, index: Ht(r) }, this.pos)), Zt(document, gt, this.move), Zt(document, vt, this.end), this.threshold || this.start(t));
                },
                start: function (t) {
                    this.drag = (function (t, e) {
                        t = xe(t, e.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g, '$1div$2'));
                        return qe(t, 'margin', '0', 'important'), qe(t, Y({ boxSizing: 'border-box', width: e.offsetWidth, height: e.offsetHeight }, qe(e, ['paddingLeft', 'paddingRight', 'paddingTop', 'paddingBottom']))), ln(t.firstElementChild, ln(e.firstElementChild)), t;
                    ...
                    Y(this.origin, { offsetLeft: this.pos.x - r, offsetTop: this.pos.y - i }),
                        ...
                        (e = this.pos),
                        (n = Date.now()),
                        (ho = setInterval(function () {
                            var t = e.x,
                                s = e.y;
                            s += window.pageYOffset;
                            var a = 0.3 * (Date.now() - n);
                            (n = Date.now()),
                                Yn(document.elementFromPoint(t, e.y))
                                    .reverse()
                                    .some(function (t) {
                                        var e = t.scrollTop,
                                            n = t.scrollHeight,
    ...
    Ci = {
        ...
        events:
            (((bi = { focus: 'show', blur: 'hide' })[wt + ' ' + bt] = function (t) {
    ...
    return (
        X(Object.freeze({ __proto__: null, Countdown: mr, Filter: o, Lightbox: tr, LightboxPanel: Jr, Notification: Qi, Parallax: er, Slider: nr, SliderParallax: br, Slideshow: Si, SlideshowParallax: br, Sortable: Hi, Tooltip: Ci, Upload: bi }), function (t, e) {
            return ii.component(e, t);
        }),
        ii
    );
